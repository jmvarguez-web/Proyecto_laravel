...
/************************mod  leronel catalogo buscar***************************/

Route::post('/getbuscar', array( 'uses'=>'CatalogoController@getbuscar',

										'as'=>'getbuscar'));
Route::post('/catalogo/getbuscar', array( 'uses'=>'CatalogoController@getbuscar',
										'as'=>'getbuscar'));
...
/*obtenemos los productos por categoria/s*/
Route::post('/getByCategorias', array( 'uses'=>'CatalogoController@getByCategorias',
										'as'=>'getByCategorias'));
/*obtenemos los productos por subcategoria/s*/
Route::post('/getBySubcategoria', array( 'uses'=>'CatalogoController@getBySubcategoria',
...
Route::post('/dologin2', array('uses' => 'LoginClientesController@doLogin2',
                                        'as' => 'doLoginCliente2'));
